...
DRAFTS: superhuman_draft creates drafts in Superhuman's own draft store, so they appear in the app's Drafts view. Drafts do not support programmatic attachments — use superhuman_send (full attachment support) or attach in the app.
