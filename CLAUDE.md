...
## Project Identity
superhuman-cli (v0.14.2) is a 40-tool MCP server + CLI for programmatic control of Superhuman email via Chrome DevTools Protocol. Fork of edwinhu/superhuman-cli with safety hardening.
