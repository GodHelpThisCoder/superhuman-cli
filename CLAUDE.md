...
## Commands
- `bun test` — Run all tests (336 tests, 28 files; a few CDP-integration tests can flake when the app is contended — re-run those files in isolation to distinguish real failures)
