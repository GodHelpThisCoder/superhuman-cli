...
## Project Identity
superhuman-cli (v0.14.2) is a 41-tool MCP server + CLI for programmatic control of Superhuman email via Chrome DevTools Protocol. Fork of edwinhu/superhuman-cli with safety hardening.
...
## Commands
- `bun test` — Run all tests (252 tests, 28 files)
